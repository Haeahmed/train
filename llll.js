        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              <div class="one"  style="transform: translateY(${t}px)">
               ...
               <span style="width: fit-content; height: fit-content; background: none;"><img  src="${file.result}" style="width: 150px; border-radius: 20px; border:1px solid var(--color-text); height: 200px;">
...
if(localStorage.getItem("nameUpdated") !== null){
    inputUserName.setAttribute("placeholder",localStorage.getItem("nameUpdated"));
...
if(localStorage.getItem("--background-color-item") !== null){
    document.documentElement.style.setProperty("--background-color-item" , localStorage.getItem("--background-color-item"));
}
...
if(localStorage.getItem("--shadow") !== null){
    document.documentElement.style.setProperty("--shadow" , localStorage.getItem("--shadow"));
}
function black3(){
    document.documentElement.style.setProperty("--background-color" , "black");
    document.documentElement.style.setProperty("--background-color-item" , "#f1f5f9");
    ...
    localStorage.setItem("--background-color" ,document.documentElement.style.getPropertyValue("--background-color"));
    localStorage.setItem("--background-color-item" , document.documentElement.style.getPropertyValue("--background-color-item"));
    localStorage.setItem("--color-text" , document.documentElement.style.getPropertyValue("--color-text"));
    localStorage.setItem("--icon-color" , document.documentElement.style.getPropertyValue("--icon-color"));
    localStorage.setItem("--shadow" , document.documentElement.style.getPropertyValue("--shadow"));
    black.textContent = "الوضع المضيء";
}
function black4(){
    document.documentElement.style.setProperty("--background-color" , "#f1f5f9");
    document.documentElement.style.setProperty("--background-color-item" , "white");
